...
public class SearchWallpapersAdapter extends Adapter<MyViewHolder> {
    private static final String TAG = "SearchWallpaperAdapter";
    ...
    public class MyViewHolder extends ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            SearchWallpapersAdapter.this.onItemClickListener.OnItemClick(getLayoutPosition());
        }
    }

    public SearchWallpapersAdapter(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder r7, int r8) {
        /*
        r6 = this;
        r0 = Fragments.SearchWallpaperFragment.resultImages;
        r0 = r0.get(r8);
        r0 = (Modals.Result) r0;
        r1 = "";
        r2 = r6.mContext;
    ...
    L_0x004c:
        ...
        r2 = r2.transition(r3);
        r3 = new Adapters.SearchWallpapersAdapter$1;
        r3.<init>(r7);
        r2 = r2.listener(r3);
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: Adapters.SearchWallpapersAdapter.onBindViewHolder(Adapters.SearchWallpapersAdapter$MyViewHolder, int):void");
    }
    ...
    public void addImages(List<Result> list) {
        if (list != null) {
            SearchWallpaperFragment.resultImages.addAll(list);
    ...
    public void clearList() {
        SearchWallpaperFragment.resultImages.clear();
    }

    public List<Result> getItemList() {
        return SearchWallpaperFragment.resultImages;
    }
}
