...
public class SearchWallCollectionAdapter extends Adapter<MyViewHolder> {
    ...
    public class MyViewHolder extends ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            SearchWallCollectionAdapter.this.onItemClickListener.OnItemClick(getLayoutPosition());
        }
    }

    public SearchWallCollectionAdapter(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder r7, int r8) {
        /*
        r6 = this;
        r0 = com.walshotbeta.walshotvbeta.SearchWallCollectionActivity.wallpaperList;
        r0 = r0.get(r8);
    ...
    L_0x004c:
        ...
        r2 = r2.transition(r3);
        r3 = new Adapters.SearchWallCollectionAdapter$1;
        r3.<init>(r7);
        r2 = r2.listener(r3);
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: Adapters.SearchWallCollectionAdapter.onBindViewHolder(Adapters.SearchWallCollectionAdapter$MyViewHolder, int):void");
    }
    ...
    public void addImages(List<Wallpaper> list) {
        if (SearchWallCollectionActivity.wallpaperList != null) {
            SearchWallCollectionActivity.wallpaperList.addAll(list);
            notifyDataSetChanged();
        }
    }

    public void clearList() {
        SearchWallCollectionActivity.wallpaperList.clear();
    }

    public List<Wallpaper> getItemList() {
        return SearchWallCollectionActivity.wallpaperList;
    }
}
