...
public class LatestImageListAdapter extends Adapter<MyViewHolder> {
    private static final int AD = 1;
    private static final int CONTENT = 0;
    private static final int LIST_AD_SPACE = 10;
    ...
    public class MyViewHolder extends ViewHolder implements OnClickListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            this.likeButton = (ImageButton) itemView.findViewById(C1420R.id.heartButtonID);
        }

        public void onClick(View v) {
            LatestImageListAdapter.this.onItemClickListener.OnItemClick(getLayoutPosition());
            String str = LatestImageListAdapter.TAG;
    ...
    public LatestImageListAdapter(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder r7, int r8) {
        /*
        r6 = this;
        r0 = Fragments.LatestFragment.wallpaperList;
        r0 = r0.get(r8);
    ...
    L_0x004c:
        ...
        r2 = r2.transition(r3);
        r3 = new Adapters.LatestImageListAdapter$1;
        r3.<init>(r7);
        r2 = r2.listener(r3);
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: Adapters.LatestImageListAdapter.onBindViewHolder(Adapters.LatestImageListAdapter$MyViewHolder, int):void");
    }

    public int getItemCount() {
        return LatestFragment.wallpaperList.size() + (LatestFragment.wallpaperList.size() / 10);
    }
    ...
    public void addImages(List<Wallpaper> list) {
        if (list != null) {
            LatestFragment.wallpaperList.addAll(list);
            notifyDataSetChanged();
        }
    }

    public void clearList() {
        LatestFragment.wallpaperList.clear();
    }

    public List<Wallpaper> getItemList() {
        return LatestFragment.wallpaperList;
    }
}
