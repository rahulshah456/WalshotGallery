...
public class PopularImageListAdapter extends Adapter<MyViewHolder> {
    private static final String TAG = "ImageListAdapter";
    private static SwipeRefreshLayout swipeRefreshLayout;
    Context mContext;
    public LatestImageListAdapter.OnItemClickListener onItemClickListener;
    ...
    public class MyViewHolder extends ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            PopularImageListAdapter.this.onItemClickListener.OnItemClick(getLayoutPosition());
        }
    }

    public PopularImageListAdapter(Context context) {
        this.mContext = context;
    }

    public void setOnItemClickListener(LatestImageListAdapter.OnItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(final MyViewHolder r7, int r8) {
        /*
        r6 = this;
        r0 = Fragments.PopularFragment.wallpaperList;
        r0 = r0.get(r8);
    ...
    L_0x004c:
        ...
        r2 = r2.transition(r3);
        r3 = new Adapters.PopularImageListAdapter$1;
        r3.<init>(r7);
        r2 = r2.listener(r3);
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: Adapters.PopularImageListAdapter.onBindViewHolder(Adapters.PopularImageListAdapter$MyViewHolder, int):void");
    }
    ...
    public void addImages(List<Wallpaper> list) {
        if (list != null) {
            PopularFragment.wallpaperList.addAll(list);
            notifyDataSetChanged();
        }
    }

    public void clearList() {
        PopularFragment.wallpaperList.clear();
    }

    public List<Wallpaper> getItemList() {
        return PopularFragment.wallpaperList;
    }
}
